...
@configclass
class FrankaLiftBananaLowDimEnvCfg(FrankaLiftEnvCfg):
    def __post_init__(self):
        ...
        # Make the end effector less stiff to not hurt the poor banana
...
@configclass
class FrankaLiftBananaEnvCfg(FrankaLiftBananaLowDimEnvCfg, FrankaLiftEnvCamCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class FrankaLiftRotatedBananaLowDimEnvCfg(FrankaLiftBananaLowDimEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class FrankaLiftRotatedBananaEnvCfg(FrankaLiftRotatedBananaLowDimEnvCfg, FrankaLiftEnvCamCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
