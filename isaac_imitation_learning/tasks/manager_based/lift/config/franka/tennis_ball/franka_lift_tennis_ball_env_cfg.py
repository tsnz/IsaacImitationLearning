...
@configclass
class FrankaLiftTennisBallLowDimEnvCfg(FrankaLiftEnvCfg):
    def __post_init__(self):
        ...
        self.scene.object = DeformableObjectCfg(
            ...
            spawn=UsdFileCfg(
                usd_path=f"{IIL_ASSET_PATH}/tennis_ball/tennis_ball.usd",
...
@configclass
class FrankaLiftTennisBallEnvCfg(FrankaLiftTennisBallLowDimEnvCfg, FrankaLiftEnvCamCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
