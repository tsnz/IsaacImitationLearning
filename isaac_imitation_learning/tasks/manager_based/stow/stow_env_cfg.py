...
##
@configclass
class ObjectTableBinSceneCfg(InteractiveSceneCfg):
...
##
@configclass
class StowEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the lifting environment."""

    # Scene settings
    scene: ObjectTableBinSceneCfg = ObjectTableBinSceneCfg(num_envs=16, env_spacing=2.5)
    # Basic settings
